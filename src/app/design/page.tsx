  ...
  return (
    <main className="min-h-screen bg-white text-[#111827] flex flex-col justify-between overflow-x-clip">
      ...
      <section className="w-full bg-[url('/images/cta-banner-bg.webp')] bg-cover bg-center py-16 sm:py-20 relative">
        <div className="max-w-[1600px] mx-auto px-5 sm:px-8 lg:px-[104px] grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-start relative z-10">
      ...
      <section className="max-w-[1600px] mx-auto px-5 sm:px-8 lg:px-[104px] py-16 sm:py-20 w-full">
