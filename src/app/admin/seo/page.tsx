...
import { Loader2, Check, ExternalLink, Search, AlertCircle } from 'lucide-react';
  ...
  return (
    <div className="flex flex-col gap-6 max-w-3xl mx-auto pb-16">
      ...
      <p className="text-xs text-gray-400 text-center">
        Blog posts and portfolio projects use their own title &amp; description automatically — edit those from their own admin sections.
      </p>
    </div>
  );
}
