...
export default function MarketingCampaignsPage() {
  return (
    <main className="min-h-screen bg-white text-[#111827] flex flex-col overflow-x-clip">
      ...
      <section className="w-full max-w-[1600px] mx-auto px-5 sm:px-8 lg:px-[13.1%] pt-6 sm:pt-8 lg:pt-10 pb-0">
        <FadeIn direction="up">
          {/* Heading */}
      ...
      {/* ── 3-col Info Cards ── */}
      <section className="w-full max-w-[1600px] mx-auto px-5 sm:px-8 lg:px-[13.1%] pb-16 sm:pb-20">
      ...
      <section className="w-full bg-[#F5F7FA] py-16 sm:py-20 my-12">
        <FadeIn direction="up" className="max-w-[1600px] mx-auto px-5 sm:px-8 lg:px-[13.1%] flex flex-col items-center">
      ...
      <section className="w-full max-w-[1600px] mx-auto px-5 sm:px-8 lg:px-[13.1%] py-10 sm:py-16">
        <FadeIn direction="up">
