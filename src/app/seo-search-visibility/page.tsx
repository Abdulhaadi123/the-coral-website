    ...
    <main className="min-h-screen bg-white text-[#111827] flex flex-col overflow-x-clip">
      ...
      */}
      ...
      >
        ...
        <div className="max-w-[1600px] mx-auto px-5 sm:px-8 lg:px-[104px] w-full relative z-10">
      ...
      <section className="w-full bg-white py-16 sm:py-20 border-b border-gray-100">
        <FadeIn direction="up" className="max-w-[1600px] mx-auto px-5 sm:px-8 lg:px-[104px] grid grid-cols-1 md:grid-cols-12 gap-10 lg:gap-16 items-start">
          {/* Left Title */}
      ...
      <section className="w-full bg-[url('/images/cta-banner-bg.webp')] bg-cover bg-center py-16 sm:py-20 relative">
        <div className="max-w-[1600px] mx-auto px-5 sm:px-8 lg:px-[104px] relative z-10">
      ...
      <section className="w-full bg-white py-16 sm:py-20">
        <div className="max-w-[1600px] mx-auto px-5 sm:px-8 lg:px-[104px] flex flex-col items-center text-center">
      ...
      <section data-nav-dark className="w-full bg-[#21A0A3] text-white py-16 sm:py-20">
        <FadeIn direction="up" className="max-w-[1600px] mx-auto px-5 sm:px-8 lg:px-[104px] flex flex-col gap-8">
      ...
      <section className="w-full bg-white py-16 sm:py-20 text-center">
        <FadeIn direction="up" className="max-w-[1600px] mx-auto px-5 sm:px-8 lg:px-[104px] flex flex-col items-center gap-4">
