...
export default function SeoSearchVisibilityPage() {
  return (
    <main className="min-h-screen bg-white text-[#111827] flex flex-col overflow-hidden">
      ...
      <section
        className="relative w-full flex flex-col justify-center px-6 sm:px-12 lg:px-16 overflow-hidden pt-36 pb-20 sm:pt-44 sm:pb-28 lg:pt-52 lg:pb-36 min-h-[550px] sm:min-h-[650px]"
        style={{
      ...
      >
        ...
        <FadeIn direction="up" className="relative z-10 max-w-4xl mx-auto sm:mx-0 pl-10 sm:pl-11 lg:pl-11">
          ...
          {/* Heading */}
          <h1 className="text-3xl sm:text-5xl lg:text-6xl font-bold text-white leading-[1.15] tracking-tight mb-6">
      ...
      <section className="w-full bg-white py-20 sm:py-28 px-6 sm:px-12">
        <div className="max-w-4xl mx-auto flex flex-col items-center text-center">
          <FadeIn direction="up" className="flex flex-col items-center text-center mb-12 sm:mb-14">
            <h2 className="text-4xl sm:text-5xl font-bold text-[#111827] tracking-tight mb-3">
              Our SEO Standard
            </h2>
      ...
      <section className="w-full bg-[#21A0A3] text-white py-16 sm:py-24 px-6 sm:px-12">
        <FadeIn direction="up" className="max-w-6xl mx-auto flex flex-col gap-8">
          ...
          <div className="pt-2">
            <Link
              ...
              className="btn-hover-gradient inline-flex items-center gap-2 px-6 py-3 rounded-full border border-white text-white font-semibold text-sm hover:bg-white hover:text-[#21A0A3] transition-all duration-300 shadow-sm"
            >
      ...
      <section className="w-full bg-white py-20 sm:py-28 px-6 sm:px-12 text-center">
        <FadeIn direction="up" className="max-w-3xl mx-auto flex flex-col items-center gap-4">
          ...
          <h2 className="text-3xl sm:text-4xl font-bold text-[#111827] tracking-tight max-w-xl leading-snug">
