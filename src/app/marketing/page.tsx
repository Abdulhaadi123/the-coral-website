  ...
  return (
    <main className="min-h-screen bg-white text-[#111827] flex flex-col justify-between overflow-x-clip w-full max-w-full">
      ...
      <div style={{ background: 'linear-gradient(0deg, #A7F076 0%, #ffffff 50%, #ffffff 100%)' }} className="w-full pb-20 relative overflow-hidden">
        ...
        {/* Hero Container */}
        <section className="max-w-[1600px] mx-auto px-5 sm:px-8 lg:px-[13.1%] pt-6 sm:pt-8 lg:pt-10 pb-20 sm:pb-24 lg:pb-28 w-full relative min-h-[500px]">
        ...
        <section className="max-w-[1600px] mx-auto px-5 sm:px-8 lg:px-[13.1%] pt-10 w-full">
          <FadeIn direction="up">
      ...
      <section className="max-w-[1600px] mx-auto px-5 sm:px-8 lg:px-[13.1%] py-20 w-full border-t border-gray-100">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 lg:gap-16 items-start">
          ...
          <StaggerContainer className="md:col-span-7 grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-10">
            {[
              ...
              const inner = (
                <StaggerItem key={title} className={`flex flex-col gap-2 group ${href ? 'cursor-pointer' : ''}`}>
                  <div className="w-8 h-8 flex items-center justify-start text-[#111827]">
                    <Icon className="w-5 h-5" />
                  </div>
                  <div className="flex items-start justify-between gap-2 sm:min-h-[48px]">
                    <h3 className={`text-base font-bold text-[#111827] transition-colors duration-300 ${href ? 'group-hover:text-[#467923]' : ''}`}>
                      {title}
                    </h3>
                    {href && (
                      <span className="w-5 h-5 rounded-full border border-gray-400 text-gray-700 group-hover:border-[#467923] group-hover:bg-[#467923] group-hover:text-white flex items-center justify-center shrink-0 transition-all duration-300 mt-0.5">
      ...
      <section className="w-full bg-[#F0F0F0] py-16 sm:py-20">
        <FadeIn direction="up" className="max-w-[1600px] mx-auto px-5 sm:px-8 lg:px-[13.1%] flex flex-col">
      ...
      <section className="w-full bg-[#A7F076] pt-14 sm:pt-20 pb-8 sm:pb-10">
        <div className="max-w-[1600px] mx-auto px-5 sm:px-8 lg:px-[13.1%] flex flex-col">
