  ...
  return (
    <main className="min-h-screen bg-white text-[#111827] flex flex-col justify-between overflow-x-clip w-full max-w-full">
      ...
      <div style={{ background: 'linear-gradient(0deg, #A7F076 0%, #ffffff 50%, #ffffff 100%)' }} className="w-full pb-20 relative overflow-hidden">
        ...
        {/* Hero Container */}
        <section className="max-w-[1600px] mx-auto px-5 sm:px-8 lg:px-[104px] pt-6 sm:pt-8 lg:pt-10 pb-20 sm:pb-24 lg:pb-28 w-full relative min-h-[500px]">
        ...
        <section className="max-w-[1600px] mx-auto px-5 sm:px-8 lg:px-[104px] pt-10 w-full">
          <FadeIn direction="up">
      ...
      <section className="max-w-[1600px] mx-auto px-5 sm:px-8 lg:px-[104px] py-20 w-full border-t border-gray-100">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 lg:gap-16 items-start">
      ...
      <section className="w-full bg-[#F0F0F0] py-16 sm:py-20">
        <FadeIn direction="up" className="max-w-[1600px] mx-auto px-5 sm:px-8 lg:px-[104px] flex flex-col">
      ...
      <section className="w-full bg-[#A7F076] pt-14 sm:pt-20 pb-8 sm:pb-10">
        <div className="max-w-[1600px] mx-auto px-5 sm:px-8 lg:px-[104px] flex flex-col">
