  ...
  return (
    <main className="min-h-screen bg-white text-[#111827] flex flex-col overflow-x-clip">
      ...
      <section className="w-full pt-6 sm:pt-8 lg:pt-10 pb-12">
        ...
        <ScaleIn delay={0.2} className="w-full max-w-[1600px] mx-auto px-5 sm:px-8 lg:px-[104px] mt-12 sm:mt-16 flex justify-center">
      ...
      <section className="w-full pt-16 sm:pt-20">
        ...
        {/* Section Header */}
        <FadeIn direction="up" className="max-w-[1600px] mx-auto px-5 sm:px-8 lg:px-[104px] mb-12 sm:mb-16">
        ...
        <div className="w-full">
          {[
            ...
            >
              <FadeIn
                direction="up"
                className="max-w-[1600px] mx-auto px-5 sm:px-8 lg:px-[104px] grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-16 items-start"
              >
      ...
      <section className="w-full bg-white py-16 sm:py-20">
        <FadeIn direction="up" className="max-w-[1600px] mx-auto px-5 sm:px-8 lg:px-[104px] grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-16 items-start">
