  ...
  return (
    <main className="min-h-screen bg-white text-[#111827] flex flex-col overflow-x-clip">
      ...
      <section className="w-full pt-16 sm:pt-20">
        ...
        {/* Section Header */}
        <FadeIn direction="up" className="max-w-[1600px] mx-auto px-5 sm:px-8 lg:px-[13.1%] mb-12 sm:mb-16">
        ...
        <div className="w-full">
          {[
            ...
            >
              <FadeIn
                direction="up"
                className="max-w-[1600px] mx-auto px-5 sm:px-8 lg:px-[13.1%] grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-16 items-start"
              >
      ...
      <section className="w-full bg-white py-16 sm:py-20">
        <FadeIn direction="up" className="max-w-[1600px] mx-auto px-5 sm:px-8 lg:px-[13.1%] grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-16 items-start">
