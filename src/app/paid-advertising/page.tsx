...
export default function PaidAdvertisingPage() {
  return (
    <main className="min-h-screen bg-white text-[#111827] flex flex-col overflow-x-clip">
      ...
      >
        <div className="max-w-[1600px] mx-auto px-5 sm:px-8 lg:px-[13.1%] pt-6 sm:pt-8 lg:pt-10 pb-0">
          <FadeIn direction="up">
            {/* Label */}
      ...
      <section className="max-w-[1600px] mx-auto px-5 sm:px-8 lg:px-[13.1%] py-16 sm:py-24 w-full">
        <div>
          <FadeIn direction="up">
