...
export const FooterSection: React.FC = () => {
  return (
    <footer data-nav-dark className="w-full relative bg-black text-white pt-16 pb-12 overflow-hidden">
      ...
      <div className="max-w-[1600px] mx-auto px-5 sm:px-8 lg:px-[13.1%] relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8">
        ...
        <div className="lg:col-span-5 flex flex-col gap-6 sm:gap-8 justify-between">
          ...
          {/* Social Cards Grid — managed from /admin/social-links */}
          <FooterSocialLinks />
