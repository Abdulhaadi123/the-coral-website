...
export const HeroSection: React.FC = () => {
  return (
    <section className="w-full max-w-[1600px] mx-auto px-5 sm:px-8 lg:px-[104px] pt-6 sm:pt-8 lg:pt-10 pb-12 sm:pb-16 flex flex-col items-start overflow-x-hidden">
      <FadeIn direction="up">
