      ...
      <div className="max-w-7xl mx-auto px-8 sm:px-16 lg:px-24">
        ...
        <div className="mt-16 sm:mt-20 flex flex-col items-center">
          ...
          <div className="mt-6 flex flex-wrap items-center justify-center gap-4 sm:gap-5">
            {/* Webflow */}
            <div className="inline-flex items-center gap-2.5 px-4 py-2.5 rounded-lg border border-gray-300 bg-white">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" aria-hidden>
                <path d="M17.5 3L12 12.5 8.5 7.5 3 15h5l2.5-4L14 18l7-15h-3.5z" fill="#4353FF" />
              </svg>
              <span className="text-sm font-semibold text-[#111827]">Webflow</span>
              <span className="text-gray-300">|</span>
              <span className="text-sm text-gray-600">Professional Partner</span>
            </div>
            ...
            <div className="inline-flex items-center gap-2.5 px-4 py-2.5 rounded-lg border border-gray-300 bg-white">
              ...
              <span className="text-sm font-semibold text-[#111827]">Meta</span>
              <span className="text-gray-300">|</span>
            ...
            <div className="inline-flex items-center gap-2.5 px-4 py-2.5 rounded-lg border border-gray-300 bg-white">
              ...
              <span className="text-sm font-semibold text-[#111827]">Google</span>
              <span className="text-gray-300">|</span>
